...
int main(void)
{
    ...
    long int VISAevencheck1, VISAevencheck2, VISAevencheck3, VISAevencheck4, VISAevencheck5, VISAevencheck6,
         VISAevencheck7, VISAevencheck8;
    ...
    {
        if (Number >= 100000000000000 && Number <= 999999999999999) // Check if 15 digits
        {
    ...
    if (Number >= 1000000000000000 && Number <= 9999999999999999) // Check if 16 digits
    {
        MASTERCARDCheck = floor(Number / 100000000000000);  // Gets the first digit of Number and round down
        if (MASTERCARDCheck == 51 || MASTERCARDCheck == 52 || MASTERCARDCheck == 53 || MASTERCARDCheck == 54
            || MASTERCARDCheck == 55) // Check whether Number begins with 51/52/53/54/55
        {
            printf("MASTERCARD\n");
        }
        else
        {
            if (MASTERCARDCheck == 56)
            {
                printf("INVALID\n");
            }
        }
    ...
    {
        VISACheck = floor(Number / 1000000000000000); // Gets the first digit of Number and round down
    ...
    if (Number >= 1000000000000 && Number <= 9999999999999) // Check if Visa (13 Digits)
    {
        ...
        {
            // Dividing into odd/even digit place (123456 -> 1,123,12345)
            VISAoddcheck1 = Number / 1000000000000;
            VISAevencheck1 = Number / 100000000000;
            VISAoddcheck2 = Number / 10000000000;
            VISAevencheck2 = Number / 1000000000;
            VISAoddcheck3 = Number / 100000000;
            VISAevencheck3 = Number / 10000000;
            VISAoddcheck4 = Number / 1000000;
            VISAevencheck4 = Number / 100000;
            VISAoddcheck5 = Number / 10000;
            VISAevencheck5 = Number / 1000;
            VISAoddcheck6 = Number / 100;
            VISAevencheck6 = Number / 10;
            VISAoddcheck7 = Number / 1;
            // Getting the last digit of the odd/even (1,123,12345 -> 1, 3, 5) and multiply each of them by 2 (only for odd)
            VISAodd1 = (2 * (VISAoddcheck1 % 10));
            VISAodd2 = (2 * (VISAoddcheck2 % 10));
            VISAodd3 = (2 * (VISAoddcheck3 % 10));
            ...
            // Add all the odd/even result together
            VISAfinalOdd = VISAodd1 + VISAodd2 + VISAodd3 + VISAodd4 + VISAodd5 + VISAodd6 + VISAodd7;
            VISAfinalEven = VISAeven1 + VISAeven2 + VISAeven3 + VISAeven4 + VISAeven5 + VISAeven6;
            // Add all final result and get only the last digit
            VISAfinal = (VISAfinalOdd + VISAfinalEven) % 10;
            // Check whether last digit = 0 or not
            if (VISAfinal == 0)
