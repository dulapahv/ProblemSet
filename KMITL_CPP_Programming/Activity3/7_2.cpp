...
//
// 3. get the difference of current number and previous number and write them into the file
// result = value of current number - value of previous number
// store them into the file
// let value of previous number = value of current number
